# ЗАДАЧІ:
# 1. Розрахувати коефіцієнт кожної з літер new
# 2. Відсортувати по велечині масиви original і new
# 3. Взяти найбільші значення origin і new
# 4. Порахувати відстань між найбільшим значенням origin і new
# 5. Взяти декілька наступних по величині значень. Переконатись, що відстань однакова.
# 6. Вивести 2 результати: зміщення на відстань в кожну зі сторін
